...
static MAX_HEADER_LEN_DEFAULT: u16 = 65535;
static MAX_DATA_PACKET_LEN_DEFAULT: u16 = 16384;
...
#[dynamic]
pub(crate) static MAX_HEADER_LEN: u16 = env::var("MAX_HEADER_LEN")
    .map_or(MAX_HEADER_LEN_DEFAULT, |value| {
        value.parse().unwrap_or(MAX_HEADER_LEN_DEFAULT)
    });

#[dynamic]
pub(crate) static MAX_DATA_PACKET_LEN: u16 = env::var("MAX_DATA_PACKET_LEN")
    .map_or(MAX_DATA_PACKET_LEN_DEFAULT, |value| {
        value.parse().unwrap_or(MAX_DATA_PACKET_LEN_DEFAULT)
    });
...
#[dynamic]
pub(crate) static ENDIAN: u8 = env::var("ENDIAN")
    .map_or(ENDIAN_DEFAULT, |value| {
