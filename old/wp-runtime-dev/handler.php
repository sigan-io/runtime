...
require_once __DIR__ . '/lambda-database-check.php';
require_once __DIR__ . '/lambda-internet-check.php';
require_once __DIR__ . '/lambda-headers-check.php';
...
lambda_info( 'Loading: {local_path}', array( 'local_path' => $local_path ) );
